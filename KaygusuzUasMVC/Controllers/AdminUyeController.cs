...
using KaygusuzUasMVC.Models;

namespace KaygusuzUasMVC.Controllers
{
    public class AdminUyeController : Controller
    {
        private DBKaygusuzuasEntities db = new DBKaygusuzuasEntities();
        ...
        public ActionResult Login(Uye uye)
        {
            ...
            {
                ViewBag.HataliGiris = "Hatalı Giriş Denemesi Yaptınız.Tekrar Deneniyiniz";
                return View();
            }
